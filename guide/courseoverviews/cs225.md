...
* Linked lists
* Stacks/Queues
* Trees (Includes regular binary search trees and AVL trees)
* Disjoint sets
* Heaps
* Hash tables
* Graphs
...
* **Problem of the Day (POTD)**: Daily coding assignments given for 1 point of extra credit posted on PrairieLearn. These assignments vary in length and may or may not be worth doing depending on how lengthy the current POTD is and your own schedule.
